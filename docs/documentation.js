 ...
 * @param {constant.applesignin_scope} One of the scope constants
 * 
 * @example
 ...
 * @param token {string} The session identity token
 * 
 * @example
 ...
 * Studio IDE and it is required that you create an executable for the target platform to properly test.
 *
 * @section_func
